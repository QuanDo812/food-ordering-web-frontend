...
const menuItemReducer = (state = initialState, action) => {
  switch (action.type) {
    ...
    case actionTypes.UPDATE_MENU_ITEMS_AVAILABILITY_REQUEST:
      case actionTypes.GET_ITEM_BY_ID_REQUEST:
    case actionTypes.CREATE_REVIEW_FOOD_REQUEST:
      return {
        ...state,
        loading: true,
        error: null,
    ...
    case actionTypes.CREATE_REVIEW_FOOD_SUCCESS:
    ...
    case actionTypes.CREATE_REVIEW_FOOD_FAILURE:
    ...
    case actionTypes.UPDATE_MENU_ITEMS_AVAILABILITY_FAILURE:
      case actionTypes.GET_ITEM_BY_ID_FAILURE:
      return {
        ...state,
        loading: false,
