...
export const CREATE_REVIEW_FOOD_SUCCESS = 'CREATE_REVIEW_FOOD_SUCCESS';
export const CREATE_REVIEW_FOOD_REQUEST = 'CREATE_REVIEW_FOOD_REQUEST';
export const CREATE_REVIEW_FOOD_FAILURE = 'CREATE_REVIEW_FOOD_FAILURE';
